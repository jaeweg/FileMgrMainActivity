...
//        }
    ...
    public void showDropDown() {
        ...
        if(getText().length() > 0)
            ...
            mPopup.getListView().setBackgroundResource(R.drawable.footerbar_popup_window_background_color);
    }
...
//    }
    ...
    private void showTextClearButton() {
    	if(isRTL()) {
            this.setCompoundDrawablesWithIntrinsicBounds(R.drawable.hw_ic_clear, 0, 0, 0);
    	} else {
            this.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.hw_ic_clear, 0);
    	}
        this.setOnTouchListener(new ClearButtonOnTouchListener(this) {
            ...
            public boolean onDrawableTouchDown(MotionEvent event) {
            	if(isRTL()) {
                    SearchEditBox.this.setCompoundDrawablesWithIntrinsicBounds(R.drawable.hw_ic_clear, 0,
                        0, 0);
            	} else {
                    SearchEditBox.this.setCompoundDrawablesWithIntrinsicBounds(0, 0,
                        R.drawable.hw_ic_clear, 0);
            	}
                event.setAction(MotionEvent.ACTION_CANCEL);
                SearchEditBox.this.setText("");
                if(!SearchEditBox.this.isCursorVisible()){
                    SearchEditBox.this.setCursorVisible(true);
                }
                return false;
            }
