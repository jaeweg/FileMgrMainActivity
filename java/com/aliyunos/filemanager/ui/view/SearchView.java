...
import com.aliyunos.filemanager.ui.view.SearchEditBox.OnBackDownListener;
import com.aliyunos.filemanager.ui.view.SearchEditBox.SearchEditBoxListener;
...
public class SearchView extends LinearLayout {
    ...
    private OnClickListener mOnBackButtonClickListener;
...
//	private View mSearchDivider;
	private ImageView mDomainLayout;
...
//	private TextView mBackButton;
	...
	private void init(Context context) {
        ...
        this.mSearchIcon = (ImageView) findViewById(R.id.hw_searchview_icon);
	...
	/**
	 * Set the onClickListener of BackButton
	 * It should be called before {{@link #initRealEditText()}
	 * 
...
//	    this.mBackButton = (TextView) findViewById(R.id.hw_searchview_back);
	    //hide back button for new ui design
...
//        mBackButton.setLayoutParams(params);
	    if (this.mOnBackButtonClickListener == null) {
			this.mOnBackButtonClickListener = new OnClickListener() {
				@Override
				public void onClick(View v) {
					animateToNormal();
				}
...
//        this.mSearchDivider = this.mSearchLayout.findViewById(R.id.hw_searchview_divider);
        this.mDomainLayout = (ImageView) this.mSearchLayout.findViewById(R.id.hw_searchview_domain);
        ...
        this.mAutoCompleteTextView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mDomainLayout.setOnClickListener(mOnBackButtonClickListener);
...
//		}
        ...
        mAutoCompleteTextView.setDropDownBackgroundDrawable(getResources().getDrawable(R.drawable.footerbar_popup_window_background_color));
...
//		mBackButton.startAnimation(backTranslate);
        ...
        if(mAnchorView != null) {
    		...
    		actionbarTranslate.setAnimationListener(new AnimationListener() {
